...
Before I flew out, <mark>I started a LiveJournal account. That's how I became a digital publisher</mark>. I just started writing for Nunu, so she could track my progress abroad.

**2003** I flew to Japan with a company called NOVA. I tried to get upgraded to first class by wearing a suit. Denied.

NOVA went bankrupt. Before it did I taught as an English teacher in the heart of Tokyo, in Kokubunji. I wore a suit every day and I hated the suit but I loved the teaching. I saw an ad for a pilot program. NOVA needed teachers in elementary schools. I applied. I was one of only four to get the position. <mark>To start my career, I taught English to Japanese children for one year</mark>.

**2004** In 2004 I started teaching yoga. I taught at Paper Tiger, a donation-based studio I started above an izakaya in downtown Kiryu. My first students were the Japanese teachers whose students I taught English. I was ready for the next challenge, and I taught myself CSS and HTML to prepare for it.

**2005** In 2005, at the completion of a year teaching, I cranked it to the next level. <mark>I rolled my teaching money into the key money and deposit on a yoga studio in Yokohama, Japan</mark>. Besides the studio, co-owner Patrick and I also co-podcasted Zen is Stupid for three and a half years.

**2006-2007** I ran Yoga Garden until 2007, when I became a freelance designer with a company called Zaadz. Zaadz was later acquired by Gaiam, and before that I did design work, and then traveled all over the States meeting my co-workers I only knew from the internet. Then, I co-founded Buddhist Geeks.
...
That year, I went to BlogHer for the first time. I decided the next year I would aim to speak at the conference. In 2007, I also live-tweeted the event. That was early days, and nobody was live-tweeting. I just thought it would be a crazy idea, so I did.
...
**2009-2010** In 2009 I married. We are now divorced. At the time I learned a lot from him about programming. He worked for a startup that was acquired. During that time, I got an invite to Social Web Foo Camp, which I accepted. I did commercial for HP, launched Best 09 (which grew to 730 participants in a few weeks).
...
The magazine is Experience Life, and I later did consulting with them and can't say enough good things about that team. I ran Reverb 10 with two others, from November 30 to December 30 2010. Three thousand people participated.
...
**2012-2013** From 2012 to 2013 I unplugged to travel. I sold my iPhone in the Mission and continue to live without a phone to this day. I earned, and earn, my living by writing to the inboxes of thousands of you located all over the globe. I made a living [as a writer](/presence). 

**2013** I wanted to know what was next in tech. I flew all over the globe - Mexico, SF, Berlin, Japan, Singapore and back to the States - to find out. While I did that, I powered down my social accounts to travel and be _in_ it rather than _reporting about it_. 

I didn't find what's next in tech. Since I didn't find it, I decided I'd have to create it. I became a programmer. <mark>I taught myself [Git](http://git.gwenbell.com), Node.js, JavaScript, Linux, Unix, the command line.</mark> I won a game of Twilight Imperium to kick it off. 

As of May 2014 I write, I program and, when available, I drink sangria with my housemates in Bed-Stuy, Brooklyn, New York.

Thank you for reading and [giving](http://gittip.com/gwenbell).
